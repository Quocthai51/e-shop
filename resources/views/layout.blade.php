                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                       ...
                       <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-5">
                                    <img src="{{asset('public/frontend/images/iphone-12-pro-og-202009.jpg')}}" class="girl img-responsive" alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-4">
                                    <img src="{{asset('public/frontend/images/laptop-lenovo-s340-81n70064vn.jpg')}}" class="girl img-responsive" alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-4">
                                    <img src="{{asset('public/frontend/images/samsung-tab-s6-cu-gia-re-cho-tot.jpg')}}" class="girl img-responsive" alt="" />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            <h2>Mua nhanh</h2>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="{{URL::to('/danh-muc-san-pham/laptop')}}">Laptop</a></li>
                                <li><a href="{{URL::to('/danh-muc-san-pham/may-tinh-bang')}}">Tablet</a></li>
                                <li><a href="{{URL::to('/danh-muc-san-pham/dien-thoai')}}">Di động</a></li>
